...
def main():
    ...
    if not data_exists:
        ...
        subprocess.run([sys.executable, "get_data.py"], check=True)
    else:
    ...
    if not specs_exist:
        ...
        subprocess.run([sys.executable, "generating_spectrograms.py"], check=True)
    else:
    ...
    subprocess.run([sys.executable, "augment_spectrograms.py"], check=True)
